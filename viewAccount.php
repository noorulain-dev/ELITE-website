...
<header id="aboutheader">	
	...
	<nav id="JNav">
		<ul>
			<li><a href="index.html">Our Products+</button></li>
	...
	<div class="b_container">
		...
		<figure class="page_banner">
			...
			<p id="banner_text"> USER ACCOUNT </p>
			
		</figure>
	</div>

	<h1 class="registerh"> WELCOME </h1>


	<p class="center"> Welcome back to ELite Furniture, <?php
	session_start();
	if(isset($_SESSION['username'])){echo $_SESSION['username'];} ?>! </p>

	<button onclick="window.location = 'editAccount.php'">
